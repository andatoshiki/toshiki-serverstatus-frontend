...
<template>
  <div class="page-container">
    ...
    <div class="footer">
      ...
      <a href="https://toshiki.dev">Anda Toshiki</a>
      <span>, and securely hosted in 🇺🇸.</span>
    </div>
  </div>
</template>
...
const loadData = () => {
  axios
    .get<ServerStat>('https://toshiki-proxy.andatoshiki.workers.dev/http%3A%2F%2Fnetwork.tosh1ki.de%2Fjson%2Fstats.json')
    .then((res) => {
